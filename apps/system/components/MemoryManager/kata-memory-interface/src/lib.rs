...
pub fn kata_cnode_alloc(size_bits: usize)
    -> Result<ObjDescBundle, MemoryManagerError>
{
    let mut objs = ObjDescBundle::new(
        unsafe { MEMORY_RECV_CNODE },
...
#[inline]
pub fn kata_sched_context_alloc(size_bits: usize)
    -> Result<ObjDescBundle, MemoryManagerError>
{
    let mut objs = ObjDescBundle::new(
        unsafe { MEMORY_RECV_CNODE },
...
#[inline]
pub fn kata_frame_alloc(space_bytes: usize)
    -> Result<ObjDescBundle, MemoryManagerError>
{
...
#[inline]
pub fn kata_frame_alloc_in_cnode(space_bytes: usize)
    -> Result<ObjDescBundle, MemoryManagerError>
{
    fn howmany(value: usize, unit: usize) -> usize {
        (value + (unit - 1)) / unit
...
#[inline]
pub fn kata_object_free_in_cnode(
    request: &ObjDescBundle,
) -> Result<(), MemoryManagerError> {
...
#[inline]
pub fn kata_object_free_toplevel(objs: &ObjDescBundle)
    -> Result<(), MemoryManagerError>
{
