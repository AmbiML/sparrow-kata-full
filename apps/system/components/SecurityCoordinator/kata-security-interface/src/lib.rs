...
pub fn kata_security_request<T: Serialize + SecurityCapability>(
    ...
    trace!("kata_security_request {:?} cap {:?}",
...
#[inline]
#[allow(dead_code)]
pub fn kata_security_echo(request: &str)
...
#[inline]
#[allow(dead_code)]
pub fn kata_security_install(pkg_contents: &ObjDescBundle)
    -> Result<String, SecurityRequestError>
{
    let reply = &mut [0u8; SECURITY_REPLY_DATA_SIZE];
    kata_security_request(
...
#[inline]
#[allow(dead_code)]
pub fn kata_security_uninstall(bundle_id: &str)
    -> Result<(), SecurityRequestError>
{
    kata_security_request(
...
#[inline]
#[allow(dead_code)]
pub fn kata_security_size_buffer(bundle_id: &str)
...
#[inline]
#[allow(dead_code)]
pub fn kata_security_get_manifest(bundle_id: &str)
    -> Result<String, SecurityRequestError>
{
    let reply = &mut [0u8; SECURITY_REPLY_DATA_SIZE];
    kata_security_request(
...
#[inline]
#[allow(dead_code)]
pub fn kata_security_delete_key(
    bundle_id: &str,
    key: &str,
) -> Result<(), SecurityRequestError> {
    kata_security_request(
